...
const importCheck = spawnSync(
  ...
  [
    ...
    [
      ...
      "  }",
      '  if (typeof module.installTikTokActivityCollector !== "function") {',
      '    throw new Error("Thiếu separated activity collector export");',
      "  }",
      '  console.log("Separated collector exports OK.");',
      "})",
    ].join("\n"),
  ],
  {
